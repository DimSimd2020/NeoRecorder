...
- **FFmpeg** — требуется для работы приложения
...
> FFmpeg автоматически устанавливается вместе с приложением. Никаких дополнительных действий не требуется.
>
> **Разработка из исходного кода:**  
> `ffmpeg.exe` **не включён в репозиторий** из-за ограничений GitHub по размеру файлов (207 МБ).  
> Скачайте FFmpeg: https://ffmpeg.org/download.html  
> Поместите `ffmpeg.exe` в корень проекта для разработки или сборки.
